import{_ as n,e as s}from"./app.68dcf065.js";const a={},p=s(`<h1 id="transform-dsa-and-storage-data" tabindex="-1"><a class="header-anchor" href="#transform-dsa-and-storage-data" aria-hidden="true">#</a> Transform dsa and storage data</h1><p>The CICS Storage dashboards requires a combination of dsa and storage data. In order to achieve this we need to add and run a transform.</p><p>Here is the sample transform:</p><div class="language-json ext-json line-numbers-mode"><pre class="language-json"><code>PUT _transform/transform_cics_dsa_storage
<span class="token punctuation">{</span>
  ...
  <span class="token property">&quot;dest&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;index&quot;</span><span class="token operator">:</span> <span class="token string">&quot;transform_cicspa_dsa_storage&quot;</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
