import{_ as n,e as s}from"./app.ab41b6a4.js";const a={},p=s(`<h1 id="transform-dsa-and-storage-data" tabindex="-1"><a class="header-anchor" href="#transform-dsa-and-storage-data" aria-hidden="true">#</a> Transform dsa and storage data</h1><p>The CICS Storage dashboards requires a combination of dsa and storage data. In order to achieve this we need to add and run a transform.</p><p>Here is the sample transform:</p><div class="language-json ext-json line-numbers-mode"><pre class="language-json"><code>PUT _transform/transform_cics_dsa_storage
